...
one to another currency based on spot prices (average) provided by 'ECB Data Portal' (European
...
Maybe we want to fetch the *last* 10 years of annual data for different currencies *as of a specific period/date*. Let's assume we want data from 2020 up to 10 years into the past:
